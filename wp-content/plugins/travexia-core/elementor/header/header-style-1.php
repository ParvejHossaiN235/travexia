 ...
 * @since 1.0.0
 */
class Hexa_Header_Style_One extends Widget_Base
{
    ...
    protected function register_contents_section()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Book Now', 'hexacore'),
                'title' => esc_html__('Enter text', 'hexacore'),
                'label_block' => true,
            ]
        );
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute('button', 'class', 'tr-btn');
...
$widgets_manager->register(new Hexa_Header_Style_One());
