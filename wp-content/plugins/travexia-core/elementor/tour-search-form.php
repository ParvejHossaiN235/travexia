...
class Hexa_Tour_Search_Form extends Widget_Base
{
    ...
    public function banner_content()
    {
        ...
        $this->start_controls_section(
            'section_hero_banner',
            [
                'label' => __('Section Content', 'hexacore'),
        ...
        $this->add_control(
            ...
            [
                ...
                'rows' => '10',
                'label_block' => true,
                'default' => __('We have been operating for over a decade, providing top-notch an <br> services to our clients and building a strong track record', 'hexacore'),
            ]
        );
...
?>
        ...
        <?php if ($settings['hexa_design_layout']  == 'layout_2') :
            ...
            $this->add_render_attribute('title', 'class', 'tr-section-title mb-15 hexa-el-title');
        ...
        ?>
            ...
            <div class="tr-discount-area">

                <div class="tr-discount-wrap p-relative z-index-1">
                    <?php if (!empty($settings['image']['url'])) { ?>
                        <div class="tr-discount-thumb d-none d-xl-block">
                    ...
                    <div class="row">
                        <div class="col-xxl-10 col-xl-12">
                            <div class="tr-discount-content">
                                <?php if (!empty($settings['title'])) {
                                    echo $title_html;
                                } ?>
                                <?php if (!empty($settings['desc'])) : ?>
                                    <p class="hexa-el-desc mb-30">
                                ...
                                <div class="tr-hero-search-box">
                                    <form action="<?php echo esc_url($settings['btn_link']['url']); ?>" method="get">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="tr-hero-widget-btn text-start text-lg-end">
                                                    <button type="submit" class="tr-btn-green text-center">
