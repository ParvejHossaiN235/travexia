...
?>
        ...
        ?>
            ...
            <section class="need-area hf-el-section <?php echo $settings['hexa_light_switcher'] ? 'need-inner' : 'need-spacing theme-bg-4'; ?>  pb-200">
                <div class="container">
                                ...
                                <div class="need-shape">
                                    ...
                                    <?php if (!empty($hexa_image2)) : ?>
                                        <div class="need-shape-two">
                                            <img src="<?php echo esc_url($hexa_image2); ?>" alt="<?php echo esc_attr($hexa_image_alt2); ?>">
                                        </div>
                                    <?php endif; ?>
                                ...
                                <div class="hfsection-wrapper">
                                    <?php if (!empty($settings['hexa_about_sub_title'])) : ?>
                                        <div class="hfbanner__sub-title mb-15">
                                            <span class="text-white hf-el-subtitle"><?php echo hexa_kses($settings['hexa_about_sub_title']); ?></span>
                                            <i>
                                    ...
                                    <?php if (!empty($settings['hexa_about_description'])) : ?>
                                        <p class="text-white hf-el-content"><?php echo hexa_kses($settings['hexa_about_description']); ?></p>
                                    <?php endif; ?>
                                </div>
                                        ...
                                        <div class="need-item d-flex mb-60">
                                            ...
                                            <div class="need-content">
                                                <?php if (!empty($item['about_features_title'])) : ?>
                                                    <h4 class="need-title mb-15 hf-el-rep-title"><?php echo hexa_kses($item['about_features_title']); ?></h4>
                                                <?php endif; ?>
                                                ...
                                                <?php if (!empty($item['about_features_btn_text'])) : ?>
                                                    <a class="hf-el-rep-btn" href="<?php echo esc_url($link); ?>"><?php echo hexa_kses($item['about_features_btn_text']); ?>
                            ...
                            <div class="keyword-content pb-100 ">
                                    ...
                                    <?php foreach ($settings['about_features_list'] as $key => $item) : ?>
                                        <li class="hf-el-rep-icon"><?php if ($item['hexa_box_icon_type'] == 'icon') : ?>
                                            ...
                                            <?php else : ?>
                                                ...
                                                <?php endif; ?>
                                            <?php endif; ?>
                                            <span class="hf-el-rep-title"><?php echo $item['about_features_title'] ? hexa_kses($item['about_features_title']) : NULL; ?></span>
                                        </li>
                                    <?php endforeach; ?>
                                ...
                                <?php if (!empty($settings['hexa_about_btn_text'])) : ?>
                                    <div class="keyword-btn">
                                        <a <?php echo $this->get_render_attribute_string('hf-button-arg'); ?>><?php echo hexa_kses($settings['hexa_about_btn_text']); ?></a>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
                            ...
                            <div class="hfchoose-thumb p-relative mb-50">
                                ...
                                <div class="hfchoose-shape d-none d-lg-block">
                                    ...
                                    <div class="hfchoose-shape-three">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/shape/choose-shape-3.png" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <li>
                                            <div class="feature-list-4-item p-relative d-flex <?php echo $key == 1 ? 'pl-100' : NULL;
                                                ...
                                                <div class="feature-list-4-content">
                                                    <?php if (!empty($item['about_features_title'])) : ?>
                                                        <h4 class="title hf-el-rep-title"><?php echo hexa_kses($item['about_features_title']); ?></h4>
                                                    <?php endif; ?>
                                                    <?php if (!empty($item['about_features_des'])) : ?>
                                                        <p class="hf-el-rep-des"><?php echo hexa_kses($item['about_features_des']); ?></p>
                                                    <?php endif; ?>
                        ...
                        <div class="col-lg-7">
                            <div class="about-5">
                                <div class="about-5-section mb-70">
                                    <?php if (!empty($settings['hexa_about_sub_title'])) : ?>
                                        <span class="sub-title hf-el-subtitle"><?php echo hexa_kses($settings['hexa_about_sub_title']); ?></span>
                                    <?php endif; ?>
                                    <?php
                                    if (!empty($settings['hexa_about_title'])) :
                                        printf(
                                        ...
                                        <a href="<?php echo esc_url($settings['about_vid_url']); ?>" class="popup-video">
                                            <div class="about-5-shape">
                                                <div class="about-5-shape-one">
                                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/shape/video-blue.png" alt="">
                                                </div>
                                                <div class="about-5-shape-two">
                                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/shape/video-white.png" alt="">
                                                </div>
                                ...
                                <div class="seo-5-shape d-none d-md-block">
                                    ...
                                    <?php if (!empty($settings['hexa_shape_switch'])) : ?>
                                        <div class="seo-5-shape-three">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/shape/seo-5-shape-3.png" alt="">
                                        </div>
                                    <?php endif; ?>
                                    <?php if (!empty($hexa_shape_image)) : ?>
                        ...
                        <div class="col-lg-5">
                            <div class="seo-5 mb-40">
                                <div class="section-3 mb-40">
                                    ...
                                    <?php if (!empty($settings['hexa_about_sub_title'])) : ?>
                                        <span class="section-3-sub-title hf-el-subtitle"><?php echo hexa_kses($settings['hexa_about_sub_title']); ?></span>
                                    <?php endif; ?>
                                    <?php
                                    if (!empty($settings['hexa_about_title'])) :
                                        printf(
                                    ...
                                    ?>
                                        <div class="feature-inner-item">
                                            ...
                                            <div class="feature-inner-content">
                                                ...
                                                <?php if (!empty($item['about_features_title'])) : ?>
                                                    <h4 class="feature-inner-title hf-el-rep-title"><?php echo hexa_kses($item['about_features_title']); ?>
                                                    </h4>
                                                <?php endif; ?>
                                                <?php if (!empty($item['about_features_des'])) : ?>
                                                    <p class="hf-el-rep-des"><?php echo hexa_kses($item['about_features_des']); ?></p>
                        ...
                        <div class="col-lg-7">
                            <div class="feature-social">
                                <ul class="feature-list-4 feature-socia-list">
                                    ...
                                    <?php foreach ($settings['about_features_list'] as $key => $item) : $key += 1; ?>
                                        <li>
                                            <div class="feature-list-4-item p-relative d-flex <?php echo $key == 2 ? 'pl-130' : NULL; ?>">
                                                <div class="feature-list-4-icon ">
                                                    <div class="feature-list-bg p-relative">
                        ...
                        <div class="col-lg-5 align-self-end">
                            <div class="feature-inner-gallery">
                                ...
                                <div class="feature-inner-shape d-none d-md-block">
                                    <?php if (!empty($hexa_shape_image)) : ?>
                                        <img class="feature-inner-shape-1" src="<?php echo esc_url($hexa_shape_image); ?>" alt="<?php echo esc_attr($hexa_shape_image_alt); ?>">
                                    <?php endif; ?>
                                    <?php if (!empty($hexa_shape_image2)) : ?>
                                        <img class="feature-inner-shape-2" src="<?php echo esc_url($hexa_shape_image2); ?>" alt="<?php echo esc_attr($hexa_shape_image_alt2); ?>">
                                    <?php endif; ?>
                                    <?php if (!empty($hexa_shape_image3)) : ?>
                                        <img class="feature-inner-shape-3" src="<?php echo esc_url($hexa_shape_image3); ?>" alt="<?php echo esc_attr($hexa_shape_image_alt3); ?>">
                                    <?php endif; ?>
                                    <?php if (!empty($hexa_shape_image4)) : ?>
                                        <img class="feature-inner-shape-4" src="<?php echo esc_url($hexa_shape_image4); ?>" alt="<?php echo esc_attr($hexa_shape_image_alt4); ?>">
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
