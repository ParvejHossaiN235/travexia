...
<div class="postbox-meta mb-20">
   <?php if (!empty($blog_author)) : ?>
      <span><a href="<?php print esc_url(get_author_posts_url(get_the_author_meta('ID'))); ?>"><i class="fa-solid fa-user"></i> <?php echo esc_html__('By', 'travexia'); ?> <?php print ucwords(get_the_author()); ?></a></span>
   <?php endif; ?>
