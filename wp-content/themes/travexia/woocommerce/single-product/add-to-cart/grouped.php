...
<div class="product__details-action">
	...
	<form class="cart grouped_form hexa-single-cart-form" action="<?php echo esc_url(apply_filters('woocommerce_add_to_cart_form_action', $product->get_permalink())); ?>" method="post" enctype='multipart/form-data'>
					...
					?>
									<div class="hexa-product-details-action-item-wrapper d-flex align-items-center">
										<div class="hexa-product-details-quantity">
											<div class="hexa-product-quantity mb-15 mt-15">
												<?php
		...
		<?php if ($quantites_required && $show_add_to_cart_button) : ?>
			...
			<div class="hexa-product-details-add-to-cart mb-35 w-100">
